...
<header class={isActive ? 'is-active' : ''}> 
    <nav>
        ...
        <ul style="--total: 4;">
            <li style="--i: 1;"><a href="#frontender-worden">Frontender worden?</a></li>
            <li style="--i: 2;"><a href="#aansluiting-praktijk">Aansluiting op praktijk</a></li>
            <li style="--i: 3;"><a href="#studio-model">Het studiomodel</a></li>
            <li style="--i: 4;"><a href="#veelgestelde-vragen">Veelgestelde vragen</a></li>
        </ul>
    </nav>
</header>
